...
WebUI.waitForElementVisible(findTestObject('Object Repository/Hamburger_Item/btntext-about'), 5)
WebUI.click(findTestObject('Object Repository/Hamburger_Item/btntext-about'))
WebUI.verifyElementVisible(findTestObject('Object Repository/Hamburger_Item/BuildAppsVerify'), FailureHandling.STOP_ON_FAILURE)
WebUI.closeBrowser()