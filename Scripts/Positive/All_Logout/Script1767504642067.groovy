...
WebUI.waitForElementVisible(findTestObject('Object Repository/Hamburger_Item/btntext-logout'), 5)
WebUI.click(findTestObject('Object Repository/Hamburger_Item/btntext-logout'))
WebUI.verifyElementVisible(findTestObject('Object Repository/Hamburger_Item/LoginLogoVerify'), FailureHandling.STOP_ON_FAILURE)
WebUI.closeBrowser()