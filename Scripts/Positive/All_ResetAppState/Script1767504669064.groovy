...
WebUI.waitForElementClickable(findTestObject('Object Repository/Hamburger_Item/btn-Add-to-cart'), 5)
WebUI.delay(3)
...
WebUI.waitForElementVisible(findTestObject('Object Repository/Hamburger_Item/btntext-resetappstore'), 5)
WebUI.click(findTestObject('Object Repository/Hamburger_Item/btntext-resetappstore'))
